...
<div markdown = "0" class="syntaxhighlighter razor csharp"><table cellspacing="0" cellpadding="0" border="0"><tbody><tr><td class="gutter"><div class="line number1 index0 alt2">1</div><div class="line number2 index1 alt1">2</div><div class="line number3 index2 alt2">3</div><div class="line number4 index3 alt1">4</div><div class="line number5 index4 alt2">5</div><div class="line number6 index5 alt1">6</div><div class="line number7 index6 alt2">7</div><div class="line number8 index7 alt1">8</div></td><td class="code"><div class="container"><div class="line number1 index0 alt2"><code class="csharp razor-keyword">@helper</code> <code class="csharp plain">buildLinks(</code><code class="csharp keyword">int</code> <code class="csharp plain">start, </code><code class="csharp keyword">int</code> <code class="csharp plain">end, </code><code class="csharp keyword">string</code> <code class="csharp plain">innerContent)</code></div><div class="line number2 index1 alt1"><code class="csharp plain">{</code></div><div class="line number3 index2 alt2"><code class="csharp spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code class="csharp keyword">for</code> <code class="csharp plain">(</code><code class="csharp keyword">int</code> <code class="csharp plain">i = start; i &lt;= end; i++)</code></div><div class="line number4 index3 alt1"><code class="csharp spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code class="csharp plain">{</code></div><div class="line number5 index4 alt2"><code class="csharp spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code class="csharp plain">&lt;a </code><code class="csharp keyword">class</code><code class="csharp plain">="</code><code class="csharp razor-keyword">@(</code><code class="csharp plain">i == ViewBag.CurrentPage ? "current</code><code class="csharp string">" : "</code><code class="csharp plain">"</code><code class="csharp razor-keyword">)</code><code class="csharp plain">" href="</code><code class="csharp razor-keyword">@</code><code class="csharp plain">Url.Action("products</code><code class="csharp string">", "</code><code class="csharp plain">home", </code><code class="csharp keyword">new</code> <code class="csharp plain">{ page = i, sortBy = ViewBag.sortBy, isAsc = ViewBag.isAsc })"&gt;</code><code class="csharp razor-keyword">@(</code><code class="csharp plain">innerContent ?? i.ToString()</code><code class="csharp razor-keyword">)</code><code class="csharp plain">&lt;/a&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </code></div><div class="line number6 index5 alt1"><code class="csharp spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code class="csharp plain">}</code></div><div class="line number7 index6 alt2"><code class="csharp spaces">&nbsp;&nbsp;&nbsp;&nbsp;</code>&nbsp;</div><div class="line number8 index7 alt1"><code class="csharp plain">}</code></div></div></td></tr></tbody></table></div>
